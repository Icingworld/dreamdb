...
public:
     ...
     * @return 数据库 ID
     */
    virtual std::optional<common::database_id_t> resolve_database(
     ...
     * @return 集合 ID
     */
    virtual std::optional<common::collection_id_t> resolve_collection(
        const common::database_id_t database_id,
    ...
    virtual std::optional<column_info_t> resolve_column(
        const common::collection_id_t collection_id,
